...
<head>
    ...
    <!-- Tailwind CSS (CDN gardé pour les utilitaires de design rapides) -->
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 h-20" style="background: rgba(255, 255, 255, 0.8); backdrop-filter: blur(12px); border-bottom: 1px solid rgba(226, 232, 240, 0.5);">
        <div class="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="<?= Flight::get('flight.base_url') ?>dons/create" class="text-sm font-medium text-gray-600 hover:text-teal-700 transition-colors">Dons</a>
            </div>
        </div>
    </nav>
