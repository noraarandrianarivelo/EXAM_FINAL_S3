...
=======
            <a href="<?= Flight::get('flight.base_url') ?>" class="flex items-center gap-3 group">
                <div
                    class="w-12 h-12 bg-gradient-to-br from-teal-500 to-teal-700 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30 group-hover:shadow-teal-500/50 transition-all duration-300">
>>>>>>> Stashed changes
...
=======
                <a href="<?= Flight::get('flight.base_url') ?>"
                    class="text-sm font-semibold text-teal-700 border-b-2 border-teal-500 pb-1">Tableau de bord</a>
                <a href="<?= Flight::get('flight.base_url') ?>dons/create"
                    class="text-sm font-medium text-gray-600 hover:text-teal-700 transition-colors">Nouveau Don</a>
                <a href="<?= Flight::get('flight.base_url') ?>test/dispatch"
                    class="text-sm font-medium text-gray-600 hover:text-teal-700 transition-colors">Dispatch</a>
                <!-- À l'intérieur de <div class="hidden md:flex items-center gap-8"> -->
                <a href="<?= Flight::get('flight.base_url') ?>besoins"
                    class="text-sm font-medium text-gray-600 hover:text-teal-700 transition-colors">Besoins</a>
                <a href="<?= Flight::get('flight.base_url') ?>villes"
                    class="text-sm font-medium text-gray-600 hover:text-teal-700 transition-colors">Villes</a>
>>>>>>> Stashed changes
            </div>
        </div>
...
=======
        ...
        <div class="flex items-center gap-4">
            <a href="<?= Flight::get('flight.base_url') ?>dons/create"
                class="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-600 to-teal-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 hover:-translate-y-0.5 transition-all duration-300">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                Faire un don
...
=======
            <a href="<?= Flight::get('flight.base_url') ?>" class="block text-sm font-semibold text-teal-700">Tableau de
                bord</a>
            <a href="<?= Flight::get('flight.base_url') ?>dons/create"
                class="block text-sm font-medium text-gray-600">Nouveau Don</a>
            <a href="<?= Flight::get('flight.base_url') ?>test/dispatch"
                class="block text-sm font-medium text-gray-600">Dispatch</a>
            <a href="<?= Flight::get('flight.base_url') ?>dons/create"
                class="inline-flex items-center gap-2 px-5 py-2.5 bg-teal-600 text-white text-sm font-semibold rounded-xl mt-4">
>>>>>>> Stashed changes
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
    ...
    <section class="pt-32 pb-16 px-6 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto relative">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <!-- Badge -->
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 border border-teal-200 rounded-full text-teal-700 text-xs font-semibold uppercase tracking-wider mb-6">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 tracking-tight leading-tight mb-6">
                    Distribution des
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-500">Dons
                        Humanitaires</span>
                </h1>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                ...
                <div class="glass-card rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span
                            class="text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-1 rounded-full">Villes</span>
                    </div>
                ...
                <div class="glass-card rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
                    <div class="flex items-start justify-between mb-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/30 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span
                            class="text-xs font-semibold text-amber-600 bg-amber-50 px-2 py-1 rounded-full">Urgent</span>
                    </div>
                    <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-1">
                        <?= number_format($stats['total_besoins']) ?>
                    </div>
                ...
                <div class="glass-card rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
                    <div class="flex items-start justify-between mb-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-1">
                        <?= number_format($stats['total_dons']) ?>
                    </div>
                ...
                <div class="glass-card rounded-2xl p-6 group hover:shadow-xl transition-all duration-300">
                    <div class="flex items-start justify-between mb-4">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg shadow-teal-500/30 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span
                            class="text-xs font-semibold text-teal-600 bg-teal-50 px-2 py-1 rounded-full">Distribué</span>
                    </div>
                    <div class="text-3xl md:text-4xl font-bold text-gray-900 mb-1">
                        <?= number_format($stats['total_attributions']) ?>
                    </div>
    ...
    <section class="py-16 px-6 relative">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-10">
                <div>
                    <span class="text-xs font-bold uppercase tracking-widest text-teal-600 mb-2 block">Distribution par
                        ville</span>
...
=======
                    <a href="<?= Flight::get('flight.base_url') ?>test/dispatch"
                        class="inline-flex items-center gap-2 text-sm font-semibold text-teal-600 hover:text-teal-700 transition-colors group">
>>>>>>> Stashed changes
                        Gérer les dons
                ...
                <div class="space-y-6">
                    <?php foreach ($villesData as $ville): ?>
                        ...
                        <div class="glass-card rounded-2xl p-6 hover:shadow-xl transition-all duration-300">
                            <!-- En-tête de la ville -->
                            <div
                                class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 pb-6 border-b border-gray-200">
                                <div class="flex items-center gap-4 mb-4 md:mb-0">
                                    <div
                                        class="w-14 h-14 bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500"><?= htmlspecialchars($ville['region']) ?> •
                                            <?= $ville['nb_besoins'] ?> besoin<?= $ville['nb_besoins'] > 1 ? 's' : '' ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-4">
                                    <div class="text-right">
                                        ...
                                        <div class="text-2xl font-bold text-teal-600"><?= number_format($pourcentage, 1) ?>%
                                        </div>
                                    </div>
                                    <span
                                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold <?= $statusClass ?> border">
                                        <?= $statusIcon ?>
                                        <?= $statusText ?>
                                    </span>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-6">
                                <div class="bg-white/50 rounded-xl p-4">
                                    ...
                                    <div class="text-2xl font-bold text-gray-900"><?= number_format($ville['total_besoins']) ?>
                                    </div>
                                </div>
                                <div class="bg-white/50 rounded-xl p-4">
                                    <div class="text-xs text-gray-500 mb-1">Reçu</div>
                                    <div class="text-2xl font-bold text-emerald-600"><?= number_format($ville['total_recus']) ?>
                                    </div>
                                </div>
                                <div class="bg-white/50 rounded-xl p-4">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between text-sm mb-2">
                                    ...
                                    <span class="text-gray-500"><?= number_format($ville['total_recus']) ?> /
                                        <?= number_format($ville['total_besoins']) ?></span>
                                </div>
                                <div class="h-3 bg-gray-100 rounded-full overflow-hidden">
                                    <div class="h-full <?= $progressClass ?> rounded-full transition-all duration-500"
                            ...
                            <?php if (!empty($ville['besoins'])): ?>
                                <div class="space-y-3">
                                    <h4 class="text-sm font-bold text-gray-700 uppercase tracking-wider mb-3">Détail des besoins
                                    </h4>
                                        ...
                                        <div class="bg-white rounded-xl p-4 border border-gray-200">
                                            <div class="flex items-start justify-between mb-3">
                                                <div class="flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-500">Demandé le
                                                        <?= date('d/m/Y', strtotime($besoin['date_besoin'])) ?>
                                                    </p>
                                                </div>
                                                <div class="text-right">
                                                    <div
                                                        class="<?= $besoinBgClass ?> <?= $besoinStatusClass ?> px-3 py-1.5 rounded-lg text-sm font-bold">
                                            ...
                                            <div class="grid grid-cols-3 gap-3 mb-2">
                                                <div>
                                                    ...
                                                    <div class="text-sm font-bold text-gray-900">
                                                        <?= number_format($besoin['quantite_besoin']) ?>
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-sm font-bold text-red-600"><?= number_format($besoin['reste']) ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                                                <div class="h-full progress-bar rounded-full transition-all duration-500"
                                                    style="width: <?= min($besoinPourcentage, 100) ?>%"></div>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-teal-500 to-teal-700 rounded-lg flex items-center justify-center">
