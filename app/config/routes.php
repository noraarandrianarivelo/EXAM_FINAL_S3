...
use app\controllers\CategorieBesoinController;
...
$router->group('', function (Router $router) use ($app) {
	...
	// Routes pour les Catégories de Besoins
	Flight::route('GET /categories', ['app\controllers\CategorieBesoinController', 'index']);
	Flight::route('GET /categories/create', ['app\controllers\CategorieBesoinController', 'create']);
	Flight::route('POST /categories', ['app\controllers\CategorieBesoinController', 'store']);
	Flight::route('GET /categories/@id/edit', ['app\controllers\CategorieBesoinController', 'edit']);
	Flight::route('POST /categories/@id/update', ['app\controllers\CategorieBesoinController', 'update']);
	Flight::route('GET /categories/@id/delete', ['app\controllers\CategorieBesoinController', 'delete']);
